        ...
        <section id="reviews">
            <div className="row">
                ...
                <div className="reviews__wrapper">
                    <div className="review" data-aos="fade-down-right">
                    ...
                    <div className="review" data-aos="fade-down-left">
                    <div className="review__header">
                ...
                <div className="reviews__btn--wrapper" data-aos="fade-down-right">
